...
pygame.display.set_caption('Nürburgring Race')
...
# images
playerImage = pygame.image.load('data/car1.png')
car3 = pygame.image.load('data/car3.png')
car4 = pygame.image.load('data/car4.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('data/car2.png')
sample = [car3,car4,baddieImage]
wallLeft = pygame.image.load('data/left.png')
wallRight = pygame.image.load('data/right.png')
